...
public class QLearning1 {
    ...
    private static void train()
    {
        ...
        for(int j = 0; j < ITERATIONS; j++)
        {
            ...
            {
                System.out.println("INITIAL_STATES["+ i +"]" + INITIAL_STATES[i]);
    ...
    private static void chooseAnAction()
    {
        ...
        System.out.println("possibleAction = " + possibleAction);
    ...
    {
        System.out.println("reward = " + (R[currentState][Action] + (GAMMA * maximum(Action, false))));
...
// Q-Learning Example 1: http://mnemstudio.org/path-finding-q-learning-example-1.htm
